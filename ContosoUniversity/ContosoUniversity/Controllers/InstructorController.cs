...
namespace ContosoUniversity.Controllers
{
    public class InstructorController : Controller
    {
        ...
        {
            //Load relational data to add to view model
            ...
            //gets the list of enrollments for a selected course
            if (id != null)
            {
        ...
        //calls the PopulateAssignedCourseData method not because there might be courses 
        ...
        //adds each selected course to the Courses navigation property before the template code that 
        //checks for validation errors and adds the new instructor to the database
        [HttpPost]
        ...
        //adds eager loading for the Courses navigation property and calls the new PopulateAssignedCourseData 
        ...
        private void UpdateInstructorCourses(string[] selectedCourses, Instructor instructorToUpdate)
        {
            if (selectedCourses == null)
            {
                ...
                //the Courses navigation property with an empty collection:
        ...
        //If the instructor is assigned as administrator of any department, removes the instructor assignment from that department. 
