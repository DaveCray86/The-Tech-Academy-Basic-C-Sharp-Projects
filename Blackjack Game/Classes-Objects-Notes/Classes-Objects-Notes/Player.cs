...
{
    public class Player                                                  //'<T>' represents the type we pass in.
    {
        public Player(string name, int beginningBalance)            //Player constructor. Player object created from input.
        {
            Hand = new List<Card>();
